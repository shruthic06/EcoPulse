...
exports.renderEnvironmentalSection = renderEnvironmentalSection;
exports.renderHealthSection = renderHealthSection;
exports.renderGreenwashingSection = renderGreenwashingSection;
exports.renderDetailedAnalysis = renderDetailedAnalysis;
...
function getEnvironmentalImpact(material) {
    const key = material.toLowerCase();
    return MATERIAL_IMPACT[key] ?? "Environmental impact data not available";
}
/** Render the environmental analysis section */
function renderEnvironmentalSection(analysis) {
    const lines = ["## Environmental Analysis", ""];
...
function renderHealthSection(chemicalRisks) {
    const lines = ["## Health Analysis", ""];
...
function renderGreenwashingSection(signals) {
    const lines = ["## Greenwashing Risk", ""];
    if (signals.length === 0) {
...
//# sourceMappingURL=detailed-analysis.js.map